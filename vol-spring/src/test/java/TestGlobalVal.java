...
public class TestGlobalVal {
	...
	public static void main(String[] args) throws ParseException {
		...
		resa1.setPassager(jeanclaude);
		daoReservation.save(resa1);
		
		resa2.setPassager(jeanphilippe);
		daoReservation.save(resa2);
		
		resa3.setPassager(jacques);
		daoReservation.save(resa3);
		
		resa4.setPassager(francis);
		...
		resa2.setClient(sopra);
		daoReservation.save(resa2);
		
		resa3.setClient(hugues);
		daoReservation.save(resa3);
		
		resa4.setClient(fernand);
		daoReservation.save(resa4);
	}
